...
function checkRendite() {
	...
	var Rend_funding = document.getElementById("Rend_funding").value;
	...
	dataString = encodeURI("function=" + func + "&HP_Key=" + HP_Key
			...
			+ "&Rend_fremdkapital=" + Rend_fremdkapital + "&Rend_funding=" + Rend_funding
	...
	$.ajax({
		...
		async : false,
		success : function() {
			// alert("success : function() ="); //Jetzt dokumente hochladen on Profil ?
